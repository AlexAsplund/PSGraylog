...
.NOTES
    Auto generated
#>
function Test-GLSidecarConfigurationVariablesValidateConfigurationVariable {
    ...
    process {
        if ($PSCmdlet.ShouldProcess($Body,"Validate a configuration variable")) {
            $QueryArray = @()
            ...
            $APIPath = '/sidecar/configuration_variables/validate'
