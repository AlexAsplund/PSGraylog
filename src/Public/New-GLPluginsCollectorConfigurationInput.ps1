...
.DESCRIPTION
    ...
    For more information about this cmdlet - please search for /plugins/org.graylog.plugins.collector/configurations/{id}/inputs in the docs available at http(s)://your-graylog.fqdn/api/api-docs
.EXAMPLE
    New-GLPluginsCollectorConfigurationInput -Id <String> -Body <PSCustomObject>
.NOTES
    Auto generated
#>
function New-GLPluginsCollectorConfigurationInput {
    ...
    process {
        if ($PSCmdlet.ShouldProcess($Id,"Create a configuration input")) {
            $QueryArray = @()
            ...
            $APIPath = '/plugins/org.graylog.plugins.collector/configurations/{id}/inputs'
