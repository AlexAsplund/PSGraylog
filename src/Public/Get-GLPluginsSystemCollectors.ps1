...
.NOTES
    Auto generated
#>
function Get-GLPluginsSystemCollectors {
    [CmdletBinding()]
    param(
    ...
    process {
        ...
        $APIPath = '/plugins/org.graylog.plugins.collector/collectors/{collectorId}'
        ...
        try {
            ...
            if ($Error[0].Exception.Response.StatusCode.value__ -eq 404) {
                Write-Error -Exception $Error[0].Exception -Message "No collector with the specified id exists" -ErrorAction $ErrorActionPreference
            }
            else {
