...
.NOTES
    Auto generated
#>
function Get-GLSidecarConfigurationsRenderConfigurationAll {
    ...
    process {
        if ($PSCmdlet.ShouldProcess($Body,"Render preview of a configuration template")) {
            $QueryArray = @()
            ...
            $APIPath = '/sidecar/configurations/render/preview'
