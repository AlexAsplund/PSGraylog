...
.DESCRIPTION
    ...
    For more information about this cmdlet - please search for /plugins/org.graylog.plugins.collector/configurations/{id}/snippets in the docs available at http(s)://your-graylog.fqdn/api/api-docs
.EXAMPLE
    New-GLPluginsCollectorConfigurationSnippet -Id <String> -Body <PSCustomObject>
.NOTES
    Auto generated
#>
function New-GLPluginsCollectorConfigurationSnippet {
    ...
    process {
        if ($PSCmdlet.ShouldProcess($Id,"Create a configuration snippet")) {
            $QueryArray = @()
            ...
            $APIPath = '/plugins/org.graylog.plugins.collector/configurations/{id}/snippets'
