...
.NOTES
    Auto generated
#>
function Set-GLSystemLoadBalancersOverride {
    ...
    process {
        if ($PSCmdlet.ShouldProcess($Status,"Override load balancer status of this Graylog server node. Next lifecycle change will override it again to its default. Set to ALIVE, DEAD, or THROTTLED.")) {
            $BodyHash = @{}
