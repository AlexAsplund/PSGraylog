...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Graylog','PSGraylog','Logging'

        # A URL to the license for this module.
        LicenseUri = 'https://github.com/AlexAsplund/PSGraylog/blob/master/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/AlexAsplund/PSGraylog/'
...
## 0.0.4
Added prepared module for PSGallery
